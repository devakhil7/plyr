    ...
    extend: {
      colors: {
        ...
        sportiq: {
          ...
          energy: "hsl(var(--sportiq-energy))",
          victory: "hsl(var(--sportiq-victory))",
        },
        status: {
      ...
      boxShadow: {
        ...
        "premium": "0 8px 32px -8px hsl(220 30% 10% / 0.2)",
        "athletic": "0 12px 40px -12px hsl(var(--primary) / 0.3)",
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
      ...
      backgroundImage: {
        ...
        "gradient-athletic": "linear-gradient(135deg, hsl(var(--primary)) 0%, hsl(var(--secondary)) 100%)",
        "gradient-energy": "linear-gradient(135deg, hsl(var(--accent)) 0%, hsl(var(--sportiq-energy)) 100%)",
