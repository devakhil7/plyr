...
import { Share2, Copy, Trophy, Star, Target, MessageCircle, Instagram, Link, Youtube } from "lucide-react";
          ...
          <div className="grid grid-cols-4 gap-2">
            <Button
              ...
              onClick={() => {
                ...
                shareToWhatsApp({ title: matchName, text, url });
              }}
            >
            ...
            <Button
              ...
              onClick={() => {
                const url = `${window.location.origin}/matches/${matchId}`;
                const text = `${matchName} - Final Score: ${teamAScore} - ${teamBScore}${motm ? ` | MOTM: ${motm.name}` : ""}`;
                shareToInstagram({ title: matchName, text, url });
              }}
            >
            ...
            <Button
              ...
              onClick={() => {
                const url = `${window.location.origin}/matches/${matchId}`;
                const text = `${matchName} - Final Score: ${teamAScore} - ${teamBScore}${motm ? ` | MOTM: ${motm.name}` : ""}`;
                shareToYouTube({ title: matchName, text, url });
              }}
            >
