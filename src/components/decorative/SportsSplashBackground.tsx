...
export function HeroSplashDecoration({ className }: SportsSplashBackgroundProps) {
  return (
    <div className={cn("absolute inset-0 overflow-hidden pointer-events-none", className)}>
      ...
      {/* Athlete silhouettes positioned around */}
      <svg 
        viewBox="0 0 100 150" 
        className="absolute bottom-10 left-[5%] w-16 h-24 text-white/10 animate-float"
      >
        {/* Runner silhouette */}
      ...
      <svg 
        viewBox="0 0 120 180" 
        className="absolute top-20 right-[8%] w-20 h-30 text-white/10 animate-float delay-300"
      >
      ...
      <svg 
        viewBox="0 0 100 150" 
        className="absolute bottom-1/4 right-[12%] w-14 h-20 text-white/8 animate-float delay-500"
      >
