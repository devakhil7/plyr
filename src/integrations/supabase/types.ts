    ...
    Tables: {
      ...
      tournament_team_players: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "tournament_team_players_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      tournament_teams: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "tournament_teams_verified_by_fkey"
            columns: ["verified_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
    ...
    Functions: {
      get_public_profile: {
        ...
        Returns: {
          ...
          profile_skill_level: Database["public"]["Enums"]["skill_level"]
        }[]
      }
      get_user_role: {
